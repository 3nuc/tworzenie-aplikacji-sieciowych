...
<template>
  <div class="grid grid-cols-3">
    <div class="col-start-2">
      ...
      <el-skeleton :loading="isFetching">
        <template #template>
          <el-card>
            <template #header>
            <div class="text-4xl">
        ...
        <el-card v-for="file in files" :key="file">
          <template #header>
            <div class="flex justify-between">
              ...
              <el-button @click="router.push(`/files/${file}`)">Otwórz</el-button>
            </div>
          </template>
        </el-card>
      </el-skeleton>
      <el-empty v-if="isEmpty">
        <router-link to="/upload">
          <el-link class="text-3xl" type="warning">Brak plików. Kliknij aby przejść do wysyłania ></el-link>
        </router-link>
      </el-empty>
    </div>
  </div>
